...
CREATE TABLE tools (
    ...
    'size 81 x 133, rpm 5000, weight 3.5 kg ', 500, 15.25);
    INSERT INTO tools VALUES('Sanders and grinders', 'SL02', 'Makita Finishing Sander', 
    'size 75 x 83, rpm 7000, weight 4.4 kg', 500, 19.15);
    INSERT INTO tools VALUES('Sanders and grinders', 'SL03', 'Cat SHEET SANDER ', 
    'size 89 x 123, rpm 10000, weight 3.8 kg ', 500, 8.50);
    INSERT INTO tools VALUES('Meters and scanners', 'IRCAM1', 'Infrared camera', 
...
CREATE TABLE main (
    ...
    toolID varchar(45) REFERENCES tools(id),
    toolName text(100) REFERENCES tools(name),
    available int DEFAULT 1,
    untilService int,
    rented varchar(150) REFERENCES customers(name),
    rentedPIN varchar(100) REFERENCES customers(peronalIDNo),
